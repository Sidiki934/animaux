...
-- Schema petgame
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `petgame` DEFAULT CHARACTER SET utf8 ;
USE `petgame` ;
...
CREATE TABLE IF NOT EXISTS `petgame`.`generique` (
  ...
  `nom` CHAR(30) CHARACTER SET 'utf8' NULL,
  PRIMARY KEY (`gen_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_general_ci
...
INSERT INTO `pet` (`pet_id`, `fname`,  `gen_id`, `cli_id`,  `race`, `gender`, `photo`,`description`) VALUES
(1, 'Felix', '5', '1', 'Labrador', 'M', NULL, NULL);
